...
export const MobileBankingHeroSection = (): JSX.Element => {
  return (
    <section
      aria-labelledby="mobile-banking-heading"
    ...
    >
      <div className="mx-auto flex min-h-[915px] w-full max-w-[1440px]">
        ...
        <img
          ...
          alt="Mobile banking app displayed on a phone"
          src="/images/mobile-banking-hero-image.png"
        />
      </div>
    </section>
  );
