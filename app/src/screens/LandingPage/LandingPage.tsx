...
const partnerLogos = [
  { alt: "nibss", className: "h-[54.21px] w-[99.38px]", src: "/images/nibss.png" },
  { alt: "unified-payment", className: "h-[54.24px] w-[219.06px]", src: "/images/unified-payment.png" },
  { alt: "lottomania", className: "h-[54.24px] w-[52.15px]", src: "/images/lottomania.png" },
  { alt: "afrigo", className: "h-[54.7px] w-[135.24px]", src: "/images/afrigo.png" },
  { alt: "microsoft azure", className: "h-[54.01px] w-[57.34px]", src: "/images/microsoft-azure.png" },
  { alt: "huawei", className: "h-[54.94px] w-[54.92px]", src: "/images/huawei.png" },
];
